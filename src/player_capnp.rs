...
pub mod player {
  ...
  impl <'a,> Builder<'a,>  {
    ...
    #[inline]
    pub fn set_player_id(&mut self, value: u32)  {
  ...
  mod _private {
    pub static ENCODED_NODE: [::capnp::Word; 49] = [
      ...
      ::capnp::word(172, 72, 207, 155, 249, 53, 148, 246),
      ...
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(0, 0, 0, 0, 0, 0, 0, 0),
      ::capnp::word(99, 108, 105, 101, 110, 116, 47, 112),
      ::capnp::word(108, 97, 121, 101, 114, 46, 99, 97),
    ...
    pub const TYPE_ID: u64 = 0xfc4b_35e0_90c0_36c2;
  }
}
